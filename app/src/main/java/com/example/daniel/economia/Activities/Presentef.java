...
public class Presentef extends AppCompatActivity {
    EditText future;
    EditText number;
    EditText interest;
    TextView result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_presentef);
    ...
    public void calculaPresente(View v){
        if(future.getText().toString().equals("hi") || number.getText().toString().equals("") || interest.getText().toString().equals("")){
            ...
            double res = futuro * Math.pow(1 / (1 + interes / 100), numero);
            result.setText("" + res);
        }
    }
}
